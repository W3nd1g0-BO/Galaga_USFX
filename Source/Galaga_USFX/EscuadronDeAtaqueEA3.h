...
#include "EscuadronDeAtaqueEA3.generated.h"

UCLASS()
class GALAGA_USFX_API AEscuadronDeAtaqueEA3 : public AActor , public IBuilderEscuadronesDeAtaque
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	AEscuadronDeAtaqueEA3();
private:
	//The Lodging Actor
	UPROPERTY(VisibleAnywhere, Category = "Escuadron EA3")
