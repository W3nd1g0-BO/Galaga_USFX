...
#include "EscuadronDeAtaqueEA5.generated.h"

UCLASS()
class GALAGA_USFX_API AEscuadronDeAtaqueEA5 : public AActor, public IBuilderEscuadronesDeAtaque
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	AEscuadronDeAtaqueEA5();
private:
	//The Lodging Actor
	UPROPERTY(VisibleAnywhere, Category = "Escuadron EA5")
